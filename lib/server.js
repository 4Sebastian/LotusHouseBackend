...
router.route('/rooms/:date/add').post(function (req, res) {
...
router.route('/events/:date/update/:id').post(function (req, res) {
  _event["default"].findById(req.params.id, function (err, event) {
...
router.route('/rooms/:date/update/:id').post(function (req, res) {
  _room["default"].findById(req.params.id, function (err, room) {
...
router.route('/events/:date/delete/:id').get(function (req, res) {
...
router.route('/rooms/:date/delete/:id').get(function (req, res) {
