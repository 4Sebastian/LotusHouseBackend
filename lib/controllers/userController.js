                    ...
                    switch (_context.prev = _context.next) {
                      ...
                      case 5:
                        ...
                        if (userName == users[cnt].userName && compareRes) {
                          found = ((0, _readOnlyError2["default"])("found"), true);
                        }

                        (0, _readOnlyError2["default"])("cnt"), cnt++;
                        _context.next = 2;
                        break;
                        ...
                        while (!found && cnt < users.length) {
                          if (userName == users[cnt].userName || email == users[cnt].email || shelterName == users[cnt].shelterName) {
                            ...
                            if (userName == users[cnt].userName) {
                              msg = ((0, _readOnlyError2["default"])("msg"), "The username is already taken");
                            } else if (email == users[cnt].email) {
                              msg = ((0, _readOnlyError2["default"])("msg"), "The email is already taken");
                            } else {
                              msg = ((0, _readOnlyError2["default"])("msg"), "The shelter name is already taken");
                            }
                          }
          ...
          case 15:
            ...
            try {
              ...
              msg = {
                ...
                text: "".concat(userName, " from ").concat(shelterName, ", has requested to create an account in the app. Their email to reference them is ").concat(email, ". If everything is good to go, here is the verification they would use within the next 30 days starting TODAY: ").concat(verifiedToken),
