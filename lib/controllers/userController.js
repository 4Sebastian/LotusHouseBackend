                    ...
                    switch (_context9.prev = _context9.next) {
                      ...
                      case 2:
                        ...
                        return _context9.abrupt("return", res.send({
                          message: 'User deleted' + ' ' + user[0].userName == userName + ' ' + compareRes + ' ' + user[0].shelterName == shelterName + ' ' + user[0].email == email
                        }));

                      case 9:
                        res.status(404);
                        return _context9.abrupt("return", res.send({
                          message: 'User not deleted' + ' ' + user[0].userName == userName + ' ' + compareRes + ' ' + user[0].shelterName == shelterName + ' ' + user[0].email == email
                        }));
