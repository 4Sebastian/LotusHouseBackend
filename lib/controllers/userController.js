...
router.post('/passwordResetRequest', authCheck, /*#__PURE__*/function () {
  var _ref7 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(req, res) {
    var email, buffer, passwordResetToken, passwordResetUrl, msg;
        ...
        switch (_context7.prev = _context7.next) {
          ...
          case 3:
            ...
            try {
              ...
              passwordResetUrl = "".concat("" + process.env.FRONTEND_URL, "/passwordReset?passwordResetToken=").concat(passwordResetToken);
