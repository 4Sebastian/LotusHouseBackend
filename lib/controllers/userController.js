    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 10:
            _user2["default"].find( /*#__PURE__*/function () {
          ...
          case 6:
            _user2["default"].find( /*#__PURE__*/function () {
              var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(err, users) {
                var cnt, found, msg, compareRes, hashedPassword, temp, _user;
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 3:
                        ...
                        _context3.next = 6;
                        return bcrypt.compare(password, user[cnt].hashedPassword);
                  ...
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      ...
                      case 1:
                        ...
                        _context7.next = 4;
                        return bcrypt.compare(password, user[i].hashedPassword);
...
router.post('/passwordReset', /*#__PURE__*/function () {
  var _ref13 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee14(req, res) {
    var password, passwordResetToken, userName, shelterName;
